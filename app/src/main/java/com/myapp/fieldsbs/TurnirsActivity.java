...
public class TurnirsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_turnirs);
        ...
        RemoveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Position1 == -1){
                    Toast.makeText(TurnirsActivity.this, "לא בחרת באף פעילות.", Toast.LENGTH_SHORT).show();
                }
                else{
                    DeleteActivity();
                    //clearing the lists
    ...
    public void setView(){
        ActivityRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ListAdapter listAdapter = new ArrayAdapter<>(TurnirsActivity.this, R.layout.customize_viewlist, ShowList);
