...
public class AssignToFieldTest {
    @Test
    public void test_assign_to_a_football_field() {
    ...
    @Test
    public void test_assign_to_a_basketball_field() {
        ActivityScenario.launch(LoginActivity.class);
        try {
            Thread.sleep(500);
        } catch (InterruptedException e) {
    ...
    @Test
    public void test_assign_to_a_gym_area() {
        ActivityScenario.launch(LoginActivity.class);
        try {
            Thread.sleep(500);
        } catch (InterruptedException e) {
